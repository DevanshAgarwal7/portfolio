                            ...
                            <div className="footer_flex_item_1_form-item">
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    <div className="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="username@gmail.com" value={queryDetails.email} onChange={handleChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="fname" class="form-label">First Name <span className="mandatory_mark">*</span></label>
                                        <input type="text" class="form-control" id="fname" name="firstName" placeholder="First Name" value={queryDetails.firstName} onChange={handleChange} />
                                    </div>
                                    <div class="mb-3">
                                        <label htmlFor="lname" class="form-label">Last Name <span className="mandatory_mark">*</span></label>
                                        <input type="text" class="form-control" id="lname" name="lastName" placeholder="Last Name" value={queryDetails.lastName} onChange={handleChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="description" class="form-label">Description <span className="mandatory_mark">*</span></label>
                                        <textarea class="form-control" id="description" rows="3" name="description" value={queryDetails.description} onChange={handleChange} ></textarea>
                                    </div>
