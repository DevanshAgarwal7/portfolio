...
function Footer() {
    const contactInformation = {
        ...
        githubLink: "https://github.com/DevanshAgarwal7",
                ...
                <div className="d-flex flex-row mb-3 justify-content-start align-items-center flex-wrap footer_flex">
                        ...
                        <div className="d-flex flex-column justify-content-center align-items-center p-2 footer_flex_item_1_form">
                            <div className="footer_flex_item_1_form-item">
                                <form onSubmit={(e) => handleSubmit(e)}>
                                    <div className="mb-3">
                                        <label htmlFor="email" className="form-label">E-mail Address <span className="mandatory_mark">*</span></label>
                                        <input type="email" className="form-control" id="email" name="email" placeholder="username@gmail.com" value={queryDetails.email} onChange={handleChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="fname" className="form-label">First Name <span className="mandatory_mark">*</span></label>
                                        <input type="text" className="form-control" id="fname" name="firstName" placeholder="First Name" value={queryDetails.firstName} onChange={handleChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="lname" className="form-label">Last Name <span className="mandatory_mark">*</span></label>
                                        <input type="text" className="form-control" id="lname" name="lastName" placeholder="Last Name" value={queryDetails.lastName} onChange={handleChange} />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="description" className="form-label">Description <span className="mandatory_mark">*</span></label>
                                        <textarea className="form-control" id="description" rows="3" name="description" value={queryDetails.description} onChange={handleChange} ></textarea>
                                    </div>
                                    <div className="mb-3 d-flex flex-row justify-content-center align-items-center">
                                        <button type="submit" className="btn btn-light form_button">Submit</button>
                                        <button type="button" className="btn btn-light form_button" onClick={handleReset}>Reset</button>
                                    </div>
                    ...
                    <div className="p-2 mx-4 footer_flex_item_2">
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <h6 style={{ color: "rgb(255, 204, 0)" }}>Contact Details</h6>
                            <div>
                                <strong style={{ color: "rgb(255, 204, 0)" }}>Address: </strong>{contactInformation.address}
                            </div>
                            <div>
                                <strong style={{ color: "rgb(255, 204, 0)" }}>E-mail : </strong>{contactInformation.email}
                            </div>
                            <div>
                                <strong style={{ color: "rgb(255, 204, 0)" }}>Mobile Number : </strong>+91 78358-97704
                            </div>
                            <h6 className="mt-2" style={{ color: "rgb(255, 204, 0)" }}>Quick Links</h6>
                            <div>
                                <div className="d-flex flex-row justify-content-center align-items-center">
                                    ...
                                    <div className="p-2 px-3 github">
                                        <a href={contactInformation.githubLink} target="_blank">
